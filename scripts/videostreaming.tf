# video streaming microservice in kubernetes cluster

locals {
    service_name = "video-streaming"
    login_server = azurerm_container_registry.sa-container-registry.login_server
    username = azurerm_container_registry.sa-container-registry.admin_username
    password = azurerm_container_registry.sa-container-registry.admin_password
